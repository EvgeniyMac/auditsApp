...
//  Education
//
//  Created by Andrey Medvedev on 03.02.2020.
...
class LibraryViewController: BaseViewController {
    ...
    override func localizeUI() {
        ...
        let titleText = Localization.string("library.navigation_bar_title")
    ...
    private func configureTabBar() {
        self.tabBarItem.title = Localization.string("library.tab_bar_title")
    }
}
