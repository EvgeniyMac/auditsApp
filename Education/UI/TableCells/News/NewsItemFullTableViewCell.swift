//
//  NewsItemFullTableViewCell.swift
//  Education
//
...
class NewsItemFullTableViewCell: UITableViewCell, NewsItemTableViewCellProtocol {
    ...
    override func awakeFromNib() {
        ...
        self.titleLabel.textColor = AppStyle.Color.white
        ...
        [self.authorLabel, self.dateLabel].forEach { (label) in
            ...
            label?.textColor = AppStyle.Color.white
        ...
        self.separatorImageView.tintColor = AppStyle.Color.white
    }

    // MARK: - NewsItemTableViewCellProtocol
    func setup(with newsItem: NewsItem) {
        self.logoImageView.image = UIImage(named: "news_placeholder.full")
