//
//  NewsItemQuarterTableViewCell.swift
//  Education
//
...
class NewsItemQuarterTableViewCell: UITableViewCell, NewsItemTableViewCellProtocol {
    ...
    func setup(with newsItem: NewsItem) {
        self.logoImageView.image = UIImage(named: "news_placeholder.quarter")
